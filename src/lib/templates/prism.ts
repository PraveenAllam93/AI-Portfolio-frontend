...
<div class="wcard-title" ${ed(`skills.${gi}.category`)}>${g.category || 'Skills'}</div>
...
<div class="hero-card">
<div class="hero-left">
<div class="hero-eyebrow">${v.profile_headline ? `<span ${ed('profile.headline')}>${v.profile_headline}</span>` : 'Designer'}</div>
